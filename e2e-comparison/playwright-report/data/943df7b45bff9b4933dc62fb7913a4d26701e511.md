...
- Name: migration-diff.spec.ts >> Angular baseline behavior checks >> home page shows Featured Highlights section title
- Location: tests/migration-diff.spec.ts:16:7
...
Locator: getByRole('heading', { name: 'Featured Highlights' })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Featured Highlights' })
