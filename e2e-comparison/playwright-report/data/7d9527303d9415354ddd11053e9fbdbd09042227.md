...
- Name: migration-diff.spec.ts >> Angular baseline behavior checks >> home page shows full hero title text
- Location: tests/migration-diff.spec.ts:4:7
...
Locator: getByRole('heading', { name: 'Welcome to Culinary Excellence' })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Welcome to Culinary Excellence' })
